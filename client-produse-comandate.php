...
<?php
			...
			$sql = "SELECT *
				FROM ComenziProduse INNER JOIN Comanda INNER JOIN Client on Client.ClientID=Comanda.ClientID on ComenziProduse.ComandaID=Comanda.ComandaID and Client.ClientID='$clientId'";
